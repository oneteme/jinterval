...
import static org.usf.jinterval.Utils.assertEmpty;
import static org.usf.jinterval.Utils.assertExceptionMsg;
import static org.usf.jinterval.Utils.intervals;
import static org.usf.jinterval.partition.multiple.Partitions.intervalPartition;
...
class PartitionsTest {
	...
	private static void assertPartEquals(List<? extends MultiModelPart<?>> actual, MultiModelPart<?>...expected) {
		...
		for(int i=0; i<expected.length; i++) {
			...
			assertEquals(expected[i].getExclusifEndIndex(), actual.get(i).getExclusifEndIndex());
